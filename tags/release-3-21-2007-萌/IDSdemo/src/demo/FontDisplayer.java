...
public class FontDisplayer extends JComponent {
    ...
    private String tmp字="萌";

    private int 九宮右下 = 512 + 30;
	...
	fdb.drawComponent(g2,tmp字,512, 九宮左上, 九宮左上,Color.BLACK,FontDB.圓體,true);		
    }
...
//	 畫九宮
	g.setColor(Color.white);
	g.fillRect(29, 29, 545, 545);
	g.setColor(Color.red);
	g.drawString(String.valueOf(fdb.test), 20, 20);
	// 長寬540
	g.drawRect(九宮左上, 九宮左上, 九宮右下, 九宮右下);// 長寬各為512，為256的兩倍
	// 二直線
	g.drawLine(210, 30, 210, 572);
	g.drawLine(390, 30, 390, 572);
	// 二橫線
	g.drawLine(30, 210, 572, 210);
	g.drawLine(30, 390, 572, 390);
    }
